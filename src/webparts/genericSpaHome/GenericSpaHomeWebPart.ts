...
import * as strings from 'GenericSpaHomeWebPartStrings';
import GenericSpaHome from './components/GenericSpaHome';
import { IGenericSpaHomeProps } from './components/IGenericSpaHomeProps';
...
export default class GenericSpaHomeWebPart extends BaseClientSideWebPart<IGenericSpaHomeWebPartProps> {
  ...
  public render(): void {
    const element: React.ReactElement<IGenericSpaHomeProps> = React.createElement(
      GenericSpaHome,
      {
